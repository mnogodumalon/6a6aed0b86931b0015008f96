...
// <custom:imports>
const NeuesUnternehmenAufnehmenPage = lazy(() => import('@/pages/intents/NeuesUnternehmenAufnehmenPage'));
const ReviewMeetingVorbereitenPage = lazy(() => import('@/pages/intents/ReviewMeetingVorbereitenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                {/* <custom:routes> */}
                <Route path="intents/neues-unternehmen" element={<Suspense fallback={null}><NeuesUnternehmenAufnehmenPage /></Suspense>} />
                <Route path="intents/review-meeting" element={<Suspense fallback={null}><ReviewMeetingVorbereitenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
          </ActionsProvider>
