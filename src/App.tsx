...
const ReviewSessionPage = lazy(() => import('@/pages/intents/ReviewSessionPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/review-session" element={<Suspense fallback={null}><ReviewSessionPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
          </ActionsProvider>
