...
const PortfolioReviewPage = lazy(() => import('@/pages/intents/PortfolioReviewPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/portfolio-review" element={<Suspense fallback={null}><PortfolioReviewPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
          </ActionsProvider>
