...
// <custom:imports>
const PortfolioOnboardingPage = lazy(() => import('@/pages/intents/PortfolioOnboardingPage'));
const UnternehmensReviewPage = lazy(() => import('@/pages/intents/UnternehmensReviewPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                {/* <custom:routes> */}
                <Route path="intents/portfolio-onboarding" element={<Suspense fallback={null}><PortfolioOnboardingPage /></Suspense>} />
                <Route path="intents/unternehmens-review" element={<Suspense fallback={null}><UnternehmensReviewPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
          </ActionsProvider>
