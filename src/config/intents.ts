...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/portfolio-onboarding', label: 'Portfolio Onboarding', icon: IconBuildingPlus, description: 'Neues Unternehmen vollständig onboarden' },
  { path: '/intents/portfolio-review', label: 'Portfolio Review', icon: IconClipboardList, description: 'Review für bestehendes Unternehmen durchführen' },
  // </custom:intents>
];
