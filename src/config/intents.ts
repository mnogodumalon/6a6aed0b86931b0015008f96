...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/unternehmen-onboarding', label: 'Unternehmen onboarden', icon: IconBuildingSkyscraper, description: 'Neues Portfoliounternehmen in 4 Schritten aufnehmen' },
  // </custom:intents>
];
