...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/unternehmen-onboarding', label: 'Unternehmen onboarden', icon: IconBuildingFactory2, description: 'Neues Portfoliounternehmen vollständig einrichten' },
