...
// <custom:intent-imports>
import { IconBuildingSkyscraper, IconClipboardCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/unternehmen-onboarding', label: 'Unternehmen onboarden', icon: IconBuildingSkyscraper, description: 'Neues Portfoliounternehmen in 4 Schritten anlegen' },
  { path: '/intents/termin-nachbereitung', label: 'Termin nachbereiten', icon: IconClipboardCheck, description: 'Termin abschließen, Protokoll ablegen, Notiz erfassen' },
  // </custom:intents>
];
