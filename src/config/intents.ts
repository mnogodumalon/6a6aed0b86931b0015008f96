...
// <custom:intent-imports>
import { IconBuildingFactory2, IconChartBar } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-beteiligung', label: 'Neue Beteiligung', icon: IconBuildingFactory2, description: 'Neue Portfoliobeteiligung in einem Flow anlegen' },
  { path: '/intents/portfolio-review', label: 'Portfolio-Review', icon: IconChartBar, description: 'Review für aktive Beteiligung vorbereiten' },
  // </custom:intents>
];
