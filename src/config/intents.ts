...
// <custom:intent-imports>
import { IconBuildingFactory, IconCalendarPlus } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/unternehmen-onboarding', label: 'Unternehmen onboarden', icon: IconBuildingFactory, description: 'Neues Portfolio-Unternehmen vollständig anlegen' },
  { path: '/intents/meeting-vorbereitung', label: 'Meeting vorbereiten', icon: IconCalendarPlus, description: 'Termin planen mit Notiz und Dokument' },
  // </custom:intents>
];
