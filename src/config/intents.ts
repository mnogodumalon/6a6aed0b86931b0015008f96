...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/unternehmen-onboarding', label: 'Unternehmen aufnehmen', icon: IconBuildingPlus, description: 'Neues Portfolio-Unternehmen vollständig anlegen' },
  { path: '/intents/portfolio-review', label: 'Portfolio-Review', icon: IconChartBar, description: 'Kennzahlen aktualisieren und nächsten Termin planen' },
  // </custom:intents>
];
