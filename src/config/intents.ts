...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/portfolio-onboarding', label: 'Portfolio aufnehmen', icon: IconBuildingPlus, description: 'Neues Unternehmen in 4 Schritten aufnehmen' },
  { path: '/intents/unternehmens-review', label: 'Portfolio-Review', icon: IconClipboardCheck, description: 'Periodisches Review für aktive Beteiligung' },
  // </custom:intents>
];
