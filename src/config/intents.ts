...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-beteiligung', label: 'Neue Beteiligung', icon: IconBuildingFactory, description: 'Neue Portfolio-Beteiligung in einem Flow anlegen' },
  { path: '/intents/termin-nachbereiten', label: 'Termin nachbereiten', icon: IconClipboardCheck, description: 'Abgehaltenen Termin abschließen und dokumentieren' },
  // </custom:intents>
];
