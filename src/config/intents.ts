...
// <custom:intent-imports>
import { IconBuildingPlus, IconClipboardCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/unternehmen-onboarding', label: 'Unternehmen onboarden', icon: IconBuildingPlus, description: 'Neues Portfolio-Unternehmen mit Termin, Dokument und Notiz anlegen' },
  { path: '/intents/portfolio-review', label: 'Portfolio-Review', icon: IconClipboardCheck, description: 'Review mit Dokument, Folgetermin und Notiz für aktive Beteiligung' },
  // </custom:intents>
];
