...
// <custom:intent-imports>
import { IconBuildingFactory, IconClipboardCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-beteiligung', label: { de: 'Neue Beteiligung', en: 'New Investment' }, icon: IconBuildingFactory, description: 'Neue Portfolio-Beteiligung in einem Flow anlegen' },
  { path: '/intents/termin-nachbereiten', label: { de: 'Termin nachbereiten', en: 'Follow Up on Appointment' }, icon: IconClipboardCheck, description: 'Abgehaltenen Termin abschließen und dokumentieren' },
  // </custom:intents>
];
