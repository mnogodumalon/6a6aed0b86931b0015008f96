...
// <custom:intent-imports>
import { IconBuildingSkyscraper, IconCalendarCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/portfolio-aufnahme', label: 'Portfolio aufnehmen', icon: IconBuildingSkyscraper, description: 'Neues Portfoliounternehmen in 4 Schritten aufnehmen' },
  { path: '/intents/meeting-abschluss', label: 'Meeting abschließen', icon: IconCalendarCheck, description: 'Geplantes Meeting protokollieren und abschließen' },
  // </custom:intents>
];
