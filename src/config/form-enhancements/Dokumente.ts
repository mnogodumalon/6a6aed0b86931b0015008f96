// Auto-generated. Per-entity form-enhancements config for "Dokumente".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["unternehmen", "dokumentenbezeichnung", "dokumententyp", "dokumentendatum", "bereitgestellt_von", "dokumentenlink", "dokumentenbeschreibung", "notizen_dokument"],
  defaults: {
