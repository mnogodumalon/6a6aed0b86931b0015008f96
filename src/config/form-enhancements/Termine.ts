...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['unternehmen', 'terminbezeichnung', 'terminart', 'wiederholung', 'datum_uhrzeit', 'terminstatus', 'erinnerung_tage', 'google_kalender', 'ort', 'notizen_termin'],
  defaults: {
    'datum_uhrzeit': { kind: 'today', withTime: true },
    'terminstatus': { kind: 'lookup', key: 'geplant', label: 'Geplant' },
    'erinnerung_tage': { kind: 'literal', value: 1 },
  },
  computed: {},
};
