// Auto-generated. Per-entity form-enhancements config for "Unternehmen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['name', 'rechtsform', 'branche', 'status', 'beteiligungsquote', 'investiertes_kapital', 'aktueller_wert', 'investitionsdatum', { row: ['stadt', 'land'], cols: '1fr 1fr' }, 'website', { row: ['ansprechpartner_vorname', 'ansprechpartner_nachname'] }, 'ansprechpartner_email', 'ansprechpartner_telefon', 'cockpit_zusammenfassung', 'allgemeine_notizen'],
  defaults: {
