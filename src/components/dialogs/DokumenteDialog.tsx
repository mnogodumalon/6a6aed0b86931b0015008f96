  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'dokumententyp': (
      <div key="dokumententyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="dokumententyp" className="max-sm:h-11"><SelectValue placeholder="Wähle den Dokumententyp" /></SelectTrigger>
          <SelectContent>
    ...
    'dokumentenbeschreibung': (
      <div key="dokumentenbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Zusammenfassung, Inhalt, Besonderheiten..."
    ...
    'dokumentendatum': (
      <div key="dokumentendatum" className="space-y-1.5">
        ...
        <DatePicker
          id="dokumentendatum"
          placeholder="Wann ist das Dokument datiert?"
          mode="date"
    ...
    'notizen_dokument': (
      <div key="notizen_dokument" className="space-y-1.5">
        ...
        <Textarea
          id="notizen_dokument"
          placeholder="Bewertung, Relevanz, Archivierungshinweise..."
