  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'dokumententyp': (
      <div key="dokumententyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="dokumententyp" className="max-sm:h-11"><SelectValue placeholder="Dokumententyp wählen" /></SelectTrigger>
          <SelectContent>
    ...
    'dokumentenbeschreibung': (
      <div key="dokumentenbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Kurze Beschreibung, Inhalt, Besonderheiten..."
    ...
    'notizen_dokument': (
      <div key="notizen_dokument" className="space-y-1.5">
        ...
        <Textarea
          id="notizen_dokument"
          placeholder="Anmerkungen, Relevanz, nächste Schritte..."
