  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'dokumententyp': (
      <div key="dokumententyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="dokumententyp" className="max-sm:h-11"><SelectValue placeholder="Dokumenttyp auswählen" /></SelectTrigger>
          <SelectContent>
    ...
    'notizen_dokument': (
      <div key="notizen_dokument" className="space-y-1.5">
        ...
        <Textarea
          id="notizen_dokument"
          placeholder="Relevante Hinweise, Besonderheiten…"
