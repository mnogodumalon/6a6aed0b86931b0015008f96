  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'dokumententyp': (
      <div key="dokumententyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="dokumententyp" className="max-sm:h-11"><SelectValue placeholder="Dokumententyp auswählen" /></SelectTrigger>
          <SelectContent>
    ...
    'dokumentenbeschreibung': (
      <div key="dokumentenbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Kurze Beschreibung oder Zusammenfassung des Dokuments..."
    ...
    'bereitgestellt_von': (
      <div key="bereitgestellt_von" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Geschäftsführer, Steuerberater"
    ...
    'notizen_dokument': (
      <div key="notizen_dokument" className="space-y-1.5">
        ...
        <Textarea
          id="notizen_dokument"
          placeholder="Relevante Hinweise, Lagerort, Zugriff..."
