  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'dokumententyp': (
      <div key="dokumententyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="dokumententyp" className="max-sm:h-11"><SelectValue placeholder="z. B. Jahresabschluss, Protokoll" /></SelectTrigger>
          <SelectContent>
    ...
    'dokumentenbeschreibung': (
      <div key="dokumentenbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Inhalt, Relevanz, Besonderheiten..."
    ...
    'bereitgestellt_von': (
      <div key="bereitgestellt_von" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Geschäftsführer Schulze"
    ...
    'notizen_dokument': (
      <div key="notizen_dokument" className="space-y-1.5">
        ...
        <Textarea
          id="notizen_dokument"
          placeholder="Zugänglichkeit, Sicherheitsstufe, Versionsinfo..."
