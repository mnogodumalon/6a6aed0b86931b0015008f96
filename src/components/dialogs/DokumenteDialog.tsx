  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'dokumentenbeschreibung': (
      <div key="dokumentenbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Worum geht es in dem Dokument? Besonderheiten, Relevanz..."
    ...
    'bereitgestellt_von': (
      <div key="bereitgestellt_von" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Hr. Schmidt, Geschäftsführung"
    ...
    'notizen_dokument': (
      <div key="notizen_dokument" className="space-y-1.5">
        ...
        <Textarea
          id="notizen_dokument"
          placeholder="Besonderheiten, zu beachten, Follow-up..."
