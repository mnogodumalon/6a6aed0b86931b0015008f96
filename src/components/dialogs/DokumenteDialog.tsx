  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'dokumentenbeschreibung': (
      <div key="dokumentenbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Quelle, Relevanz, Besonderheiten..."
    ...
    'dokumentendatum': (
      <div key="dokumentendatum" className="space-y-1.5">
        ...
        <DatePicker
          id="dokumentendatum"
          placeholder="Wann entstand das Dokument?"
          mode="date"
    ...
    'bereitgestellt_von': (
      <div key="bereitgestellt_von" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Hr. Schmidt, CFO"
    ...
    'notizen_dokument': (
      <div key="notizen_dokument" className="space-y-1.5">
        ...
        <Textarea
          id="notizen_dokument"
          placeholder="Auffälligkeiten, Kontext, Verweise..."
