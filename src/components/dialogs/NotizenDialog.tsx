  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'notiz_titel': (
      <div key="notiz_titel" className="space-y-1.5">
        ...
        <Input
          id="notiz_titel"
          placeholder="z. B. Diskussion neue Märkte"
    ...
    'notiz_inhalt': (
      <div key="notiz_inhalt" className="space-y-1.5">
        ...
        <Textarea
          id="notiz_inhalt"
          placeholder="Wichtige Punkte, Erkenntnisse, Entscheidungen, Aktionspunkte..."
    ...
    'notiz_datum': (
      <div key="notiz_datum" className="space-y-1.5">
        ...
        <DatePicker
          id="notiz_datum"
          placeholder="Wann wurde diese Notiz erstellt?"
          mode="date"
    ...
    'kategorie': (
      <div key="kategorie" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="kategorie" className="max-sm:h-11"><SelectValue placeholder="Kategorie der Notiz wählen" /></SelectTrigger>
          <SelectContent>
            ...
            <SelectItem value="risiken">Risiken</SelectItem>
            <SelectItem value="kategorie_sonstiges">Sonstiges</SelectItem>
          </SelectContent>
        </Select>
      </div>
    ),
    ...
    'schlagwoerter': (
      <div key="schlagwoerter" className="space-y-1.5">
        ...
        <Input
          id="schlagwoerter"
          placeholder="z. B. expansion, Q4, strategisch"
