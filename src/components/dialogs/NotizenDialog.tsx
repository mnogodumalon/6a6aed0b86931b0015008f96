  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'notiz_inhalt': (
      <div key="notiz_inhalt" className="space-y-1.5">
        ...
        <Textarea
          id="notiz_inhalt"
          placeholder="Was ist zu beachten? Gedanken, Erkenntnisse, Empfehlungen..."
    ...
    'kategorie': (
      <div key="kategorie" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="kategorie" className="max-sm:h-11"><SelectValue placeholder="z. B. Finanzen, Strategie" /></SelectTrigger>
          <SelectContent>
    ...
    'schlagwoerter': (
      <div key="schlagwoerter" className="space-y-1.5">
        ...
        <Input
          id="schlagwoerter"
          placeholder="z. B. M&A, IPO, Expansion"
