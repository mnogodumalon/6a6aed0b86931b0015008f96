  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'unternehmen': (
      <div key="unternehmen" className="space-y-1.5">
        ...
        <Combobox
          id="unternehmen"
          placeholder="Für welches Unternehmen?"
    ...
    'notiz_titel': (
      <div key="notiz_titel" className="space-y-1.5">
        ...
        <Input
          id="notiz_titel"
          placeholder="z. B. Gespräch mit Board"
    ...
    'notiz_inhalt': (
      <div key="notiz_inhalt" className="space-y-1.5">
        ...
        <Textarea
          id="notiz_inhalt"
          placeholder="Was wurde besprochen? Ergebnisse, nächste Schritte, Entscheidungen..."
    ...
    'schlagwoerter': (
      <div key="schlagwoerter" className="space-y-1.5">
        ...
        <Input
          id="schlagwoerter"
          placeholder="z. B. expansion, risiko, q3"
