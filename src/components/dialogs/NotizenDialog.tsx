  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'notiz_titel': (
      <div key="notiz_titel" className="space-y-1.5">
        ...
        <Input
          id="notiz_titel"
          placeholder="z. B. Expansion geplant"
    ...
    'notiz_inhalt': (
      <div key="notiz_inhalt" className="space-y-1.5">
        ...
        <Textarea
          id="notiz_inhalt"
          placeholder="Gedanken, Beobachtungen, Erkenntnisse..."
    ...
    'kategorie': (
      <div key="kategorie" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="kategorie" className="max-sm:h-11"><SelectValue placeholder="z. B. Strategie, Finanzen, Risiken" /></SelectTrigger>
          <SelectContent>
    ...
    'schlagwoerter': (
      <div key="schlagwoerter" className="space-y-1.5">
        ...
        <Input
          id="schlagwoerter"
          placeholder="z. B. growth, market-entry, risk-mitigation"
