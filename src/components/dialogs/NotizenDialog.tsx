  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'unternehmen': (
      <div key="unternehmen" className="space-y-1.5">
        ...
        <Combobox
          id="unternehmen"
          placeholder="Zu welchem Unternehmen gehört die Notiz?"
    ...
    'notiz_titel': (
      <div key="notiz_titel" className="space-y-1.5">
        ...
        <Input
          id="notiz_titel"
          placeholder="z. B. Produktlaunch geplant"
    ...
    'notiz_inhalt': (
      <div key="notiz_inhalt" className="space-y-1.5">
        ...
        <Textarea
          id="notiz_inhalt"
          placeholder="Detaillierte Notiz, Beobachtungen, Erkenntnisse, nächste Schritte..."
    ...
    'notiz_datum': (
      <div key="notiz_datum" className="space-y-1.5">
        ...
        <DatePicker
          id="notiz_datum"
          placeholder="Datum dieser Notiz"
          mode="date"
    ...
    'kategorie': (
      <div key="kategorie" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="kategorie" className="max-sm:h-11"><SelectValue placeholder="Kategorie auswählen" /></SelectTrigger>
          <SelectContent>
    ...
    'schlagwoerter': (
      <div key="schlagwoerter" className="space-y-1.5">
        ...
        <Input
          id="schlagwoerter"
          placeholder="z. B. Launch, Produkt, Q3"
