  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'notiz_titel': (
      <div key="notiz_titel" className="space-y-1.5">
        ...
        <Input
          id="notiz_titel"
          placeholder="z. B. Gründer-Interview"
    ...
    'notiz_inhalt': (
      <div key="notiz_inhalt" className="space-y-1.5">
        ...
        <Textarea
          id="notiz_inhalt"
          placeholder="Beobachtungen, Gedanken, Erkenntnisse, Risiken, Chancen..."
    ...
    'schlagwoerter': (
      <div key="schlagwoerter" className="space-y-1.5">
        ...
        <Input
          id="schlagwoerter"
          placeholder="z. B. Wachstum, Technologie"
