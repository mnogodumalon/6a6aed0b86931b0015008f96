  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'unternehmen': (
      <div key="unternehmen" className="space-y-1.5">
        ...
        <Combobox
          id="unternehmen"
          placeholder="Welches Unternehmen betrifft die Notiz?"
    ...
    'notiz_titel': (
      <div key="notiz_titel" className="space-y-1.5">
        ...
        <Input
          id="notiz_titel"
          placeholder="z. B. Expansion in Frankreich geplant"
    ...
    'notiz_inhalt': (
      <div key="notiz_inhalt" className="space-y-1.5">
        ...
        <Textarea
          id="notiz_inhalt"
          placeholder="Ausführliche Notiz mit Gedanken, Ergebnissen, nächsten Schritten, Kontakt-Info.."
    ...
    'schlagwoerter': (
      <div key="schlagwoerter" className="space-y-1.5">
        ...
        <Input
          id="schlagwoerter"
          placeholder="z. B. Expansion, Frankreich, Q4"
