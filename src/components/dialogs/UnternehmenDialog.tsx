  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'branche': (
      <div key="branche" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="branche" className="max-sm:h-11"><SelectValue placeholder="Wähle die Branche" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'cockpit_zusammenfassung': (
      <div key="cockpit_zusammenfassung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Kurze Übersicht über die Beteiligung, aktuelle Lage und relevante KPIs..."
    ...
    'allgemeine_notizen': (
      <div key="allgemeine_notizen" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Weitere Anmerkungen, besondere Ereignisse, Ausstiegsszenarien..."
