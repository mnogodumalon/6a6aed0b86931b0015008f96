    ...
    'cockpit_zusammenfassung': (
      <div key="cockpit_zusammenfassung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Geplante oder erreichte Meilensteine, Hauptkennzahlen, Entwicklung..."
    ...
    'allgemeine_notizen': (
      <div key="allgemeine_notizen" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Besonderheiten, Risiken, Chancen, sonstige Hinweise..."
