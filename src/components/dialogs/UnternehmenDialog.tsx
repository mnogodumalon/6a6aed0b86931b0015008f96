  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'rechtsform': (
      <div key="rechtsform" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="rechtsform" className="max-sm:h-11"><SelectValue placeholder="z. B. GmbH, AG, KG" /></SelectTrigger>
          <SelectContent>
    ...
    'branche': (
      <div key="branche" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="branche" className="max-sm:h-11"><SelectValue placeholder="z. B. Technologie & Software" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'cockpit_zusammenfassung': (
      <div key="cockpit_zusammenfassung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Wichtigste Kennzahlen und Status..."
    ...
    'allgemeine_notizen': (
      <div key="allgemeine_notizen" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Wichtige Notizen zur Beteiligung..."
