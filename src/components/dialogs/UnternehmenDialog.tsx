    ...
    'ansprechpartner_email': (
      <div key="ansprechpartner_email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          placeholder="z. B. max.mueller@unternehmen.de"
    ...
    'cockpit_zusammenfassung': (
      <div key="cockpit_zusammenfassung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Kurze Übersicht der Beteiligung, aktuelle Strategie..."
    ...
    'allgemeine_notizen': (
      <div key="allgemeine_notizen" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Besondere Punkte, Vereinbarungen, Beobachtungen..."
