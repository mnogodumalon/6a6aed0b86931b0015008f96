  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'rechtsform': (
      <div key="rechtsform" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="rechtsform" className="max-sm:h-11"><SelectValue placeholder="Rechtsform auswählen" /></SelectTrigger>
          <SelectContent>
    ...
    'branche': (
      <div key="branche" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="branche" className="max-sm:h-11"><SelectValue placeholder="Branche auswählen" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'cockpit_zusammenfassung': (
      <div key="cockpit_zusammenfassung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Kurzer Überblick über die Beteiligung und aktuelle Situation..."
    ...
    'allgemeine_notizen': (
      <div key="allgemeine_notizen" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Wichtige Notizen und Besonderheiten..."
