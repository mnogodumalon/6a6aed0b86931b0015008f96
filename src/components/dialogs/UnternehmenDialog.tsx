  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'branche': (
      <div key="branche" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="branche" className="max-sm:h-11"><SelectValue placeholder="z. B. Technologie, Finanzen" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'ansprechpartner_email': (
      <div key="ansprechpartner_email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          placeholder="z. B. max.mueller@techcorp.de"
    ...
    'cockpit_zusammenfassung': (
      <div key="cockpit_zusammenfassung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Kurze Übersicht der Beteiligung, Key-Metriken, Status..."
    ...
    'allgemeine_notizen': (
      <div key="allgemeine_notizen" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Besondere Entwicklungen, Meilensteine, Bedenken..."
