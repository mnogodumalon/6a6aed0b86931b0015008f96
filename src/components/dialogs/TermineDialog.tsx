  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'terminbezeichnung': (
      <div key="terminbezeichnung" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Q3 Vorstandssitzung"
    ...
    'terminart': (
      <div key="terminart" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="terminart" className="max-sm:h-11"><SelectValue placeholder="z. B. Gremiensitzung, Strategiemeeting" /></SelectTrigger>
          <SelectContent>
    ...
    'ort': (
      <div key="ort" className="space-y-1.5">
        ...
        <Input
          id="ort"
          placeholder="z. B. Konferenzsaal, Videolink"
          value={fields.ort ?? ''}
    ...
    'notizen_termin': (
      <div key="notizen_termin" className="space-y-1.5">
        ...
        <Textarea
          id="notizen_termin"
          placeholder="Agenda, Ergebnisse, Follow-ups..."
