  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'terminbezeichnung': (
      <div key="terminbezeichnung" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Q3 Gremiensitzung"
    ...
    'terminart': (
      <div key="terminart" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="terminart" className="max-sm:h-11"><SelectValue placeholder="z. B. Gremiensitzung, Beiratssitzung" /></SelectTrigger>
          <SelectContent>
    ...
    'notizen_termin': (
      <div key="notizen_termin" className="space-y-1.5">
        ...
        <Textarea
          id="notizen_termin"
          placeholder="Agenda, Ergebnisse, offene Punkte..."
