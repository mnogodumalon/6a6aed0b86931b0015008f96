  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'terminbezeichnung': (
      <div key="terminbezeichnung" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Q3-Jahresabschluss"
    ...
    'terminart': (
      <div key="terminart" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="terminart" className="max-sm:h-11"><SelectValue placeholder="Art des Termins wählen" /></SelectTrigger>
          <SelectContent>
    ...
    'datum_uhrzeit': (
      <div key="datum_uhrzeit" className="space-y-1.5">
        ...
        <DatePicker
          id="datum_uhrzeit"
          placeholder="Wann und um wie viel Uhr?"
          mode="datetime"
    ...
    'ort': (
      <div key="ort" className="space-y-1.5">
        ...
        <Input
          id="ort"
          placeholder="z. B. Berlin oder Zoom-Link"
          value={fields.ort ?? ''}
    ...
    'notizen_termin': (
      <div key="notizen_termin" className="space-y-1.5">
        ...
        <Textarea
          id="notizen_termin"
          placeholder="Agenda, Teilnehmer, Vorbereitungen..."
