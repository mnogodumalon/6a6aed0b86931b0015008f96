const STATUS_COLOR_MAP: Record<string, string> = {
  ...
  allgemein: 'bg-purple-100 text-purple-700 border-purple-200',
  beiratssitzung: 'bg-cyan-100 text-cyan-700 border-cyan-200',
  beratung: 'bg-indigo-100 text-indigo-700 border-indigo-200',
  beteiligungsvertrag: 'bg-teal-100 text-teal-700 border-teal-200',
  branche_sonstige: 'bg-pink-100 text-pink-700 border-pink-200',
  dokumententyp_sonstiges: 'bg-sky-100 text-sky-700 border-sky-200',
  einmalig: 'bg-violet-100 text-violet-700 border-violet-200',
  einzelunternehmen: 'bg-blue-100 text-blue-700 border-blue-200',
  energie: 'bg-purple-100 text-purple-700 border-purple-200',
  exit: 'bg-cyan-100 text-cyan-700 border-cyan-200',
  finanzen: 'bg-indigo-100 text-indigo-700 border-indigo-200',
  geplant: 'bg-blue-100 text-blue-700 border-blue-200',
  geschaeftsbericht: 'bg-teal-100 text-teal-700 border-teal-200',
  gesellschafterversammlung: 'bg-pink-100 text-pink-700 border-pink-200',
  gesellschaftsvertrag: 'bg-sky-100 text-sky-700 border-sky-200',
  gesundheit: 'bg-violet-100 text-violet-700 border-violet-200',
  gmbh: 'bg-blue-100 text-blue-700 border-blue-200',
  gmbh_co_kg: 'bg-purple-100 text-purple-700 border-purple-200',
  gremiensitzung: 'bg-cyan-100 text-cyan-700 border-cyan-200',
  handel: 'bg-indigo-100 text-indigo-700 border-indigo-200',
  hoch: 'bg-teal-100 text-teal-700 border-teal-200',
  immobilien: 'bg-pink-100 text-pink-700 border-pink-200',
  jaehrlich: 'bg-sky-100 text-sky-700 border-sky-200',
  jahresabschluss: 'bg-violet-100 text-violet-700 border-violet-200',
  kategorie_sonstiges: 'bg-blue-100 text-blue-700 border-blue-200',
  kg: 'bg-purple-100 text-purple-700 border-purple-200',
  medien: 'bg-cyan-100 text-cyan-700 border-cyan-200',
  meeting: 'bg-indigo-100 text-indigo-700 border-indigo-200',
  mittel: 'bg-teal-100 text-teal-700 border-teal-200',
  monatlich: 'bg-pink-100 text-pink-700 border-pink-200',
  niedrig: 'bg-sky-100 text-sky-700 border-sky-200',
  ohg: 'bg-violet-100 text-violet-700 border-violet-200',
  praesentation: 'bg-blue-100 text-blue-700 border-blue-200',
  produktion: 'bg-purple-100 text-purple-700 border-purple-200',
  protokoll: 'bg-cyan-100 text-cyan-700 border-cyan-200',
  quartalsweise: 'bg-indigo-100 text-indigo-700 border-indigo-200',
  risiken: 'bg-teal-100 text-teal-700 border-teal-200',
  sonstige: 'bg-pink-100 text-pink-700 border-pink-200',
  stattgefunden: 'bg-sky-100 text-sky-700 border-sky-200',
  strategie: 'bg-violet-100 text-violet-700 border-violet-200',
  strategiemeeting: 'bg-blue-100 text-blue-700 border-blue-200',
  technologie: 'bg-purple-100 text-purple-700 border-purple-200',
  terminart_sonstiges: 'bg-cyan-100 text-cyan-700 border-cyan-200',
  ug: 'bg-indigo-100 text-indigo-700 border-indigo-200',
  woechentlich: 'bg-teal-100 text-teal-700 border-teal-200',
};
